  ...
  return (
    <div className=" w-1/2">
      ...
      <p className=" text-slate-500 mb-8">
        ...
        quaerat ut sit pariatur voluptas corporis, nulla odio delectus dicta,
        assumenda illum
      </p>
      <form onSubmit={handleSubmit(handleProductForm)}>
        <div className="mb-5">
          ...
          {errors.product_name?.type === "maxLength" && (
            <p className=" text-sm text-red-500">
              Product name length must be shorter than 10 characters
            </p>
          )}
        </div>
        <div className=" mb-8">
          ...
          {errors.price?.type === "min" && (
            <p className="text-sm text-red-500">Price must be more than 100</p>
          )}
